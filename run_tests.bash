...
telegram-send-wait --format markdown "||Do good and find good\!||"

telegram-send-wait "https://github.com/rahiel/telegram-send"
telegram-send-wait --disable-web-page-preview "https://github.com/rahiel/telegram-send"

mkfile 19k test_file.dat
telegram-send-wait --file test_file.dat --caption "∑ ∏ ∳ ∂ ∇ ℵ ∅ ∃ ∀ ∴ ∵ ∄ ⨁ ⨂ ⫰ ⫯ ⪽ ⪾ ⨋ ⨌ ℘ ℑ ℜ"

magick -size 600x600 pattern:checkerboard -auto-level -swirl 540 -implode 0.3 swirl.png
telegram-send-wait --image swirl.png --caption "▓▒░ 🌀 W A R P _ Z O N E 🌀 ░▒▓"
...
telegram-send-wait --animation animated.gif --caption "∆ ∇ C H A O S _ T H E O R Y ∇ ∆"

#TODO: video
#TODO: audio

telegram-send-wait --location 35.5398033 -79.7488965
ncal | telegram-send-wait --pre --stdin

# Manual --wait-reply (interactive):
# telegram-send-wait "reply with any text" --wait-reply --timeout 60
# telegram-send-wait "reply to this" --wait-reply --reply-to-sent --timeout 60
